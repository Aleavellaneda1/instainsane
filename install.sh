...
(trap '' SIGINT SIGTSTP && command -v crunch > /dev/null 2>&1 || { printf >&2  "\e[1;92mInstalling crunch, please wait...\n\e[0m"; apt-get update > /dev/null && apt-get -y install crunch > /dev/null || printf "\e[1;91mCrunch Not installed.\n\e[0m"; }) & wait $!
